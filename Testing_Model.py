...
import os
import pickle
file_path = "/home/rabianajeeb/python_projects/Datasets/SER_Data/Testing_Data"
mean_signal_length = 176178
prediction_labels = []
...
def testing():
    pickle_in = open("/home/rabianajeeb/python_projects/finalyearproject/Pickle_models/model.pickle", "rb")
...
#     with open("/home/hassan/Hassaan_Home/My_Python_Projects/Speech_Emotion/Testing_labels/testing_labels_full_sentences.txt","rb") as f:
...
if __name__ == "__main__":
    print("Model is being tested on the test data . . .")
